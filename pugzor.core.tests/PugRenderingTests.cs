...
namespace pugzor.core.tests
{
    public class PugRenderingTests
    {
        ...
        public async Task Should_render_simple_view()
        {
            ...
            var pugRendering = new PugRendering(Microsoft.AspNetCore.NodeServices.NodeServicesFactory.CreateNodeServices(new Microsoft.AspNetCore.NodeServices.NodeServicesOptions(mockServices.Object)));
            var file = new System.IO.FileInfo("PugFiles/simple.pug");
